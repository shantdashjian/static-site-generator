...
def generate_pages_recursive(basepath, dir_path_content, template_path, dest_dir_path):
    ...
    for entry in entries:
        ...
        if os.path.isfile(entry_path_source):
            ...
            generate_page(basepath, entry_path_source, template_path, entry_path_destination_html)
        else:
            os.mkdir(entry_path_destination)
            generate_pages_recursive(basepath, entry_path_source, template_path, entry_path_destination)